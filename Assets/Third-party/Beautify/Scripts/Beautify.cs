...
namespace BeautifyEffect {
    ...
    public partial class Beautify : MonoBehaviour {
        ...
        const string BEAUTIFY_BUILD_HINT = "BeautifyBuildHint80RC5";
        float sunFlareCurrentIntensity;
        bool sunIsSpotlight;
        Vector4 sunLastScrPos;
        float sunLastRot;
        Texture2D flareNoise;
        RenderTexture dofDepthTexture, dofExclusionTexture, bloomSourceTexture, bloomSourceDepthTexture, bloomSourceTextureRightEye, bloomSourceDepthTextureRightEye, pixelateTexture;
        ...
        void UpdateDepthOfFieldData() {
            ...
            bMat.SetVector(ShaderParams.BokehData2, new Vector4(_depthOfFieldForegroundBlur ? _depthOfFieldForegroundDistance : currentCamera.farClipPlane, _depthOfFieldMaxSamples, _depthOfFieldBokehThreshold, _depthOfFieldBokehIntensity * _depthOfFieldBokehIntensity));
