        ...
        public override void OnInspectorGUI() {
            ...
            if (vrOn) {
                ...
                if (_quality.intValue == (int)BEAUTIFY_QUALITY.BestPerformance) {
                    ...
                    GUILayout.Label(new GUIContent("Super Sampling", "A value greater than 1 makes Beautify render camera into a bigger target and downscales it before applying effects to produce a higher quality image. This should be used only in high end configurations."), labelStyle, GUILayout.Width(121));
